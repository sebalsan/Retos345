...
public class Ortopedic implements Serializable{
    ...
    */
    ...
    /**
    *Atributo para la relacion "category"
    */
    ...
    /**
    *Atributo para la relacion "messages" que trae una lista
    */
    ...
    @JsonIgnoreProperties({"ortopedic","client"})
    /**
    *Atributo para la relacion "reservations" que trae una lista
    */
